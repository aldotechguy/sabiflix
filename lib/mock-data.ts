...
/* Cast/actor index for search-by-actor (mock). */
export const movieCast: Record<string, string[]> = {
  'mov-lagos-nights': ['Gideon Okeke', 'Rita Dominic'],
  'mov-herdsmans-daughter': ['Bimbo Ademoye', 'Femi Adebayo'],
  'mov-sun-of-the-soil': ['Narrated by Yaa Owusu'],
  ...
  'mov-serengeti-dawn': ['Narrated by Juma Nathaniel'],
